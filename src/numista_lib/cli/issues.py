...
from numista_lib.config import create_async_client_from_settings, get_settings
from numista_lib.services import IssueService
...
def register_issues_commands(parent: click.Group) -> None:
    ...
    def issues(type_id: int, limit: int) -> None:
        ...
        Examples:
            numista-lib issues 95420
            numista-lib issues 95420 --limit 100
        """
        try:
